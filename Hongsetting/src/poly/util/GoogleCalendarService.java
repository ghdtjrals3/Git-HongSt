...
public class GoogleCalendarService {
	...
	private static final java.io.File DATA_STORE_DIR = new java.io.File("C:\\calendarData");
	...
	public static Credential authorize() throws IOException {
        ...
        System.out.println("1" + clientSecrets.toString());

        // Build flow and trigger user authorization request.
        GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
                HTTP_TRANSPORT, JSON_FACTORY, clientSecrets, SCOPES)
                .setDataStoreFactory(new FileDataStoreFactory(new java.io.File("C:\\calendarData")))
                .setAccessType("offline")
                .build();
        System.out.println("1" + flow.toString());
        LocalServerReceiver receiver = new LocalServerReceiver.Builder().setPort(8888).build();
        System.out.println("1" + receiver.toString());
		
        Credential credential = new AuthorizationCodeInstalledApp(flow, receiver).authorize("user");
        System.out.println("1" + credential.toString());
		return credential;
	...
	public static Calendar getCalendarService() throws IOException {
		...
		System.out.println("2" + credential.toString());
