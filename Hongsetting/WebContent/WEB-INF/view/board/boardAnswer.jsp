...
<%
	...
	String qst_seq = (String)request.getParameter("qst_seq");
									...
									<div class="page-body">
										<div class="card">
											<div class="card-block">
												<h4 class="sub-title">제목 : <%=title%></h4>
												<p><%=content %></p>
											</div>
											<div class="card-block">
												<h4 class="sub-title">답변</h4>

												<form action="/board/boardDetail/insertData.do">
													<div class="form-group row">
														<label class="col-sm-2 col-form-label"> 작성자 </label>
														<div class="col-sm-10">
															<input type="text" placeholder="작성자" class="form-control" name="reg_name" value="" id="reg_name" style="width: 200px;">
															<input type="text" class="form-control" name="rfe_seq" style="display: none;" value='<%=qst_seq%>'>
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-10">
															<textarea rows="5" cols="5" class="form-control"
																placeholder="질문 내용" name="content"></textarea>
														</div>
													</div>
