												...
												<h4 class="sub-title">등록</h4>
															...
															<div class="modal-body">
																...
																<form class='form-margin40' role='form' action="#"
																	...
																	<div class='' style="width:1300px; float: left">
																		<label>내용</label>
																		<textarea rows="7" class='form-control'
																			id="description" name='description'></textarea>
																			<input type="text" id="calValue" value="2" style="display: none">
																	</div>

																	<div class='' style="inline-size: fit-content;">

																		<input type="button" class='btn btn-sm btn-warning'
																			value="확인" onclick="calendarSchduleAdd()" style="margin-left: 1250px; margin-top: 10px;"/>
																	</div>
